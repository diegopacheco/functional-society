...
import com.github.diegopacheco.functionalsociety.scala.fizzbuzz.ScalaFizzBuzzV2._

class ScalaFizzBuzzV2Test extends TestCase{
    ...
    def test_15_to_30_fizzbuzz():Unit = {
       ...
       assertEquals(fizzbuzz_15_30,fizzbuzz(15,16)) 
    }
